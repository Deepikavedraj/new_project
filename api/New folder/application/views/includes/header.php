    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-lg"><b><?= $this->config->item('project_name') ?></b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php
            if($is_admin == 1 ||
                (array_key_exists('Recharge', $access_info) 
                && ($access_info['Recharge']['list'] == 1 || $access_info['Recharge']['total_access'] == 1)))
            {
              ?>
            <li>
