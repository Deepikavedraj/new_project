...
class Recharge extends BaseController
{
    ...
    function bookingListing()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Booking';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = $this->config->item('project_name').' : Add New Booking';
    ...
    function edit($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Edit Booking';
