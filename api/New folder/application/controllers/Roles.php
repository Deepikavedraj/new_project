...
class Roles extends BaseController
{
    ...
    function roleListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Roles Listing';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = $this->config->item('project_name').' : Add New Role';
    ...
    function edit($roleId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Edit Role';
