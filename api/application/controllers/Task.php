...
class Task extends BaseController
{
    ...
    function taskListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Task';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = $this->config->item('project_name').' : Add New Task';
    ...
    function edit($taskId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Edit Task';
