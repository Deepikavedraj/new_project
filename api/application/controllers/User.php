...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = $this->config->item('project_name').' : Dashboard';
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : Edit User';
    ...
    {
        $this->global['pageTitle'] = $this->config->item('project_name').' : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = $this->config->item('project_name').' : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? $this->config->item('project_name').' : My Profile' : $this->config->item('project_name').' : Change Password';
