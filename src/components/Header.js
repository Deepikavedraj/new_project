...
<div className="row">
  <div className="col-md-4 col-4">
    <button className="btn join_orange">Join Green</button>
  </div>
  <div className="col-md-4 col-4">
...
<div className="col-md-3 col-2">
    <button className="btn num1">0</button>
  </div>
  <div className="col-md-2 col-2">
    <button className="btn num2">1</button>
  </div>
  <div className="col-md-2 col-2">
    <button className="btn num3">2</button>
  </div>
  <div className="col-md-2 col-2">
  ...
  <div className="row mt-2">
  <div className="col-md-3 col-2">
    <button className="btn num3">5</button>
  </div>
  
  <div className="col-md-2 col-2">
    <button className="btn num1">6</button>
  </div>
  <div className="col-md-2 col-2">
    <button className="btn num2">7</button>
  </div>
  <div className="col-md-2 col-2">
    <button className="btn num3">8</button>
  </div>
  <div className="col-md-3 col-2">
    <button className="btn num2">9</button>
  </div>
  </div>
  ...
  <div className="footer_content">
    ...
    <div className="col-md-2 col-2">
      <div className="footer_icon">
        ...
        <a href="/"><p className="text-white">Reacharge</p></a>
      </div>
    </div>
    <div className="col-md-2 col-2">
      <div className="footer_icon">
    ...
    <div className="col-md-2 col-2">
      ...
      <a href="/"><p className="text-white">Enquiry</p></a>
      </div>
    </div>
    <div className="col-md-2 col-2">
      <div className="footer_icon">
      <i class="fa fa-user" aria-hidden="true"></i>
      <a href="/"><p className="text-white">Account</p></a>
      </div>
    </div>
    </div>
  </div>
